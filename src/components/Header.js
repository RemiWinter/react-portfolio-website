  ...
  <div className="container header-container">    
    ...
    <div className="header-content">
      ...
      {/* <Animator animation={batch(Move(0,0,0,3000),Zoom(10,0))}> */}
        <p className="about-me" ref={about}>I'm a self-taught web developer based in Birmingham UK. My primary skills reside in all things front-end, specifically HTML, CSS and JavaScript. I've also got experience using C#, React, JSON, jQuery and Bootstrap. I first started coding when I was 17 in college during my spare time. However, I eventually stopped to persue a BSc Mathematics degree and returned to coding in 2020.</p>
        {/* </Animator> */}
      </div>
